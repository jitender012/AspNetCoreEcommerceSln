...
namespace eCommerce.Infrastructure.Migrations
{
    ...
    [Migration("20251005075231_RemovedProdCatAndFeatCatJunctionTable")]
    partial class RemovedProdCatAndFeatCatJunctionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCommerce.Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.Property<Guid>("ChangedByNavigationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ChangedByNavigationId");
            ...
            modelBuilder.Entity("eCommerce.Domain.Entities.QA", b =>
                {
                    ...
                    b.Property<Guid?>("AnsweredByNavigationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AnsweredByNavigationId");
            ...
            modelBuilder.Entity("eCommerce.Domain.Entities.Address", b =>
                {
                    b.HasOne("eCommerce.Domain.IdentityEntities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("eCommerce.Domain.Entities.AuditLog", b =>
                {
                    b.HasOne("eCommerce.Domain.IdentityEntities.ApplicationUser", "ChangedByNavigation")
                        .WithMany()
                        .HasForeignKey("ChangedByNavigationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("eCommerce.Domain.Entities.Brand", b =>
                {
                    b.HasOne("eCommerce.Domain.IdentityEntities.ApplicationUser", "CreatedByNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("eCommerce.Domain.Entities.ProductCategoryProductFeature", b =>
                {
                    b.HasOne("eCommerce.Domain.Entities.ProductCategory", "ProductCategory")
                        .WithMany("ProductCategoryProductFeatures")
            ...
            modelBuilder.Entity("eCommerce.Domain.Entities.QA", b =>
                {
                    b.HasOne("eCommerce.Domain.IdentityEntities.ApplicationUser", "AnsweredByNavigation")
                        .WithMany()
                        .HasForeignKey("AnsweredByNavigationId");
            ...
            modelBuilder.Entity("eCommerce.Domain.Entities.ProductCategory", b =>
                {
                    ...
                    b.Navigation("ProductCategoryProductFeatures");
